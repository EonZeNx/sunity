...
public class Item
{
    ...
    public virtual ItemStack OnUsePrimary(ItemStack stack, CharacterInventory character)
    {
    ...
    /// <param name="character">Character which used the item.</param>
    /// <returns>Whether usage was successful.</returns>
    public virtual ItemStack OnUseSecondary(ItemStack stack, CharacterInventory character)
    {
