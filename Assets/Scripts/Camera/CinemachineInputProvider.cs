...
namespace Sunity.Game.Camera
{
    public class CinemachineInputProvider : MonoBehaviour, AxisState.IInputAxisProvider
    {
        ...
        /// <summary>
        /// Whether or not to invert the look axes.
        /// </summary>
        [Tooltip("Whether or not to invert the look axes.")]
        ...
        public virtual float GetAxisValue(int axis)
        {
            ...
            if (action != null)
            {
                ...
                {
                    case 0:
                        float xVal = action.ReadValue<Vector2>().x;
                        return invertXAxis ? xVal * -1 : xVal;
                    case 1: 
                        float yVal = action.ReadValue<Vector2>().y;
                        return invertYAxis ? yVal * -1 : yVal;
                    case 2: 
